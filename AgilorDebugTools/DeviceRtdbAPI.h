...
}SERVER_INFO_RTDB, FAR* LPSERVERINFO;
...
//->
long DRTDBEXPORTS DRTDBAPI DRTDB_GetNextTagNode(long &lTagID, TAG_NODE_RTDB &TagNode);
//->added by yurui, 04/02/18
long DRTDBEXPORTS DRTDBAPI DRTDB_FindTagBySource(LPSTR sourcename, TAG_NODE_RTDB &tagnode);
//->
...
long DRTDBEXPORTS DRTDBAPI DRTDB_SendNewValue_UsingLocalID(TAG_VALUE_LOCAL &TagValue, bool bImmediate = true);
...
void DRTDBEXPORTS DRTDBAPI DRTDB_SetStateCallBackFunction(void(__stdcall *fOnGetStateInformation)(UINT, LPSTR));
void DRTDBEXPORTS DRTDBAPI DRTDB_SetWindowHandle(HWND hWnd);
//->
void DRTDBEXPORTS DRTDBAPI DRTDB_SetCallBackFunction(void(__stdcall *fOnNewTagNodeArrive)(LPTAGNODE, LPCTSTR), void(__stdcall *fOnRemoveTagNode)(LPTAGNODE, LPCTSTR), void(__stdcall *fOnSetDeviceTagValue)(LPTAGVALUELOCAL, LPCTSTR), void(__stdcall *fOnGetDeviceTagValue)(LPTAGNODE, LPCTSTR));

long DRTDBEXPORTS DRTDBAPI DRTDB_SetDeviceStatus(BOOL bDeviceIsConnected);

long DRTDBEXPORTS DRTDBAPI DRTDB_MD_FindTagBySource(LPSTR sDeviceName, LPSTR sourcename, TAG_NODE_RTDB &tagnode);
...
long DRTDBEXPORTS DRTDBAPI DRTDB_MD_GetNextTagNode(LPSTR sDeviceName, long &lTagID, TAG_NODE_RTDB &TagNode);
...
void DRTDBEXPORTS DRTDBAPI DRTDB_MD_SetCallBackFunction(LPSTR sDeviceName, void(__stdcall *fOnNewTagNodeArrive)(LPTAGNODE, LPCTSTR), void(__stdcall *fOnRemoveTagNode)(LPTAGNODE, LPCTSTR), void(__stdcall *fOnSetDeviceTagValue)(LPTAGVALUELOCAL, LPCTSTR), void(__stdcall *fOnGetDeviceTagValue)(LPTAGNODE, LPCTSTR));
